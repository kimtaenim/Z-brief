    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/30 backdrop-blur-sm sm:items-center">
      ...
      >
        <div className="mb-1 flex items-center gap-2">
          <span className="grid h-8 w-8 place-items-center rounded-full bg-mint-tint text-mint-deep">
            <LockIcon />
          </span>
        ...
        <input
          ...
          autoFocus
          className="mb-3 w-full rounded-2xl border border-border-soft bg-white px-4 py-3 text-[15px] text-text outline-none transition focus:border-mint"
          placeholder="비밀번호"
        />
        {error && (
        ...
        <button
          ...
          className="w-full rounded-2xl bg-mint-deep px-4 py-3 text-[15px] font-medium text-white transition active:scale-[0.99] disabled:opacity-50"
        >
          {pending ? "확인 중…" : "들어가기"}
        </button>
      </form>
